...
.method private updateViewPort(Ljava/util/Map;Ljava/util/Collection;)V
    ...
    invoke-virtual {v0, v2}, Landroidx/camera/core/UseCase;->setViewPortCropRect(Landroid/graphics/Rect;)V
...
.method updateUseCases(Ljava/util/Collection;Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->calculatePlaceholderForExtensions(Ljava/util/Collection;)Landroidx/camera/core/UseCase;

    move-result-object v0

    invoke-direct {p0, p1, p2}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->createOrReuseStreamSharing(Ljava/util/Collection;Z)Landroidx/camera/core/streamsharing/StreamSharing;

    move-result-object v2

    invoke-static {p1, v0, v2}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->calculateCameraUseCases(Ljava/util/Collection;Landroidx/camera/core/UseCase;Landroidx/camera/core/streamsharing/StreamSharing;)Ljava/util/Collection;
    ...
    iget-object v4, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraUseCases:Ljava/util/List;
    ...
    invoke-interface {v10, v3}, Ljava/util/List;->removeAll(Ljava/util/Collection;)Z

    iget-object v4, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraConfig:Landroidx/camera/core/impl/CameraConfig;
    ...
    invoke-direct {p0, v7, v4, v5}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->getConfigs(Ljava/util/Collection;Landroidx/camera/core/impl/UseCaseConfigFactory;Landroidx/camera/core/impl/UseCaseConfigFactory;)Ljava/util/Map;
    ...
    :try_start_3
    invoke-direct {p0, p2, v3}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->updateViewPort(Ljava/util/Map;Ljava/util/Collection;)V

    iget-object v5, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mEffects:Ljava/util/List;

    invoke-static {v5, v3, p1}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->updateEffects(Ljava/util/List;Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    iget-object v11, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraInternal:Landroidx/camera/core/impl/CameraInternal;

    invoke-virtual {v6, v11}, Landroidx/camera/core/UseCase;->unbindFromCamera(Landroidx/camera/core/impl/CameraInternal;)V

    goto :goto_0

    :cond_0
    iget-object v5, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraInternal:Landroidx/camera/core/impl/CameraInternal;

    invoke-interface {v5, v10}, Landroidx/camera/core/impl/CameraInternal;->detachUseCases(Ljava/util/Collection;)V
    ...
    invoke-virtual {v8}, Landroidx/camera/core/impl/StreamSpec;->getImplementationOptions()Landroidx/camera/core/impl/Config;
    ...
    invoke-static {v8, v11}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->hasImplementationOptionChanged(Landroidx/camera/core/impl/StreamSpec;Landroidx/camera/core/impl/SessionConfig;)Z

    move-result v8

    if-eqz v8, :cond_1

    invoke-virtual {v6, v10}, Landroidx/camera/core/UseCase;->updateSuggestedStreamSpecImplementationOptions(Landroidx/camera/core/impl/Config;)V
    ...
    iget-object v10, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraInternal:Landroidx/camera/core/impl/CameraInternal;

    iget-object v11, v8, Landroidx/camera/core/internal/CameraUseCaseAdapter$ConfigPair;->mExtendedConfig:Landroidx/camera/core/impl/UseCaseConfig;
    ...
    invoke-virtual {v6, v10, v11, v8}, Landroidx/camera/core/UseCase;->bindToCamera(Landroidx/camera/core/impl/CameraInternal;Landroidx/camera/core/impl/UseCaseConfig;Landroidx/camera/core/impl/UseCaseConfig;)V
    ...
    invoke-virtual {v6, v8}, Landroidx/camera/core/UseCase;->updateSuggestedStreamSpec(Landroidx/camera/core/impl/StreamSpec;)V

    goto :goto_2

    :cond_3
    iget-boolean p2, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mAttached:Z

    if-eqz p2, :cond_4

    iget-object p2, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraInternal:Landroidx/camera/core/impl/CameraInternal;

    invoke-interface {p2, v7}, Landroidx/camera/core/impl/CameraInternal;->attachUseCases(Ljava/util/Collection;)V
    ...
    :cond_5
    iget-object p2, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mAppUseCases:Ljava/util/List;
    ...
    iget-object p1, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraUseCases:Ljava/util/List;
    ...
    iput-object v0, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mPlaceholderForExtensions:Landroidx/camera/core/UseCase;

    iput-object v2, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mStreamSharing:Landroidx/camera/core/streamsharing/StreamSharing;
    ...
    invoke-direct {p0}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->hasNoExtension()Z

    move-result p2

    if-eqz p2, :cond_6

    iget-object p2, v4, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraCoordinator:Landroidx/camera/core/concurrent/CameraCoordinator;

    invoke-interface {p2}, Landroidx/camera/core/concurrent/CameraCoordinator;->getCameraOperatingMode()I
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/camera/core/internal/CameraUseCaseAdapter;->updateUseCases(Ljava/util/Collection;Z)V
