...
.method opEvaluateParallel(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    invoke-interface {v11, v0}, Lj$/util/Spliterator;->hasCharacteristics(I)Z
    ...
    iget-wide v12, v1, Lj$/util/stream/SliceOps$1;->val$skip:J

    iget-wide v14, v1, Lj$/util/stream/SliceOps$1;->val$limit:J
    ...
    invoke-static {v2, v0, v9, v8}, Lj$/util/stream/Nodes;->collect(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/Node;
    ...
    iget-wide v2, v1, Lj$/util/stream/SliceOps$1;->val$skip:J

    iget-wide v4, v1, Lj$/util/stream/SliceOps$1;->val$limit:J
    ...
    iget-wide v3, v0, Lj$/util/stream/SliceOps$1;->val$limit:J
...
.method opEvaluateParallelLazy(Lj$/util/stream/PipelineHelper;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v2, p0, Lj$/util/stream/SliceOps$1;->val$limit:J
