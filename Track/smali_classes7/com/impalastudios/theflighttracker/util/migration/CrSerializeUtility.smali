.class public Lcom/impalastudios/theflighttracker/util/migration/CrSerializeUtility;
...
.method public static byteArrayToObject([B)Ljava/lang/Object;
    ...
    .line 65
    invoke-static {p0, v0}, Lcom/impalastudios/theflighttracker/util/migration/CrSerializeUtility;->byteArrayToObject([BZ)Ljava/lang/Object;
...
.method public static byteArrayToObject([BZ)Ljava/lang/Object;
    ...
    .line 86
    :cond_0
    new-instance p1, Lcom/impalastudios/theflighttracker/util/migration/CrDecompressibleInputStream;

    new-instance v1, Ljava/io/ByteArrayInputStream;

    invoke-direct {v1, p0}, Ljava/io/ByteArrayInputStream;-><init>([B)V

    invoke-direct {p1, v1}, Lcom/impalastudios/theflighttracker/util/migration/CrDecompressibleInputStream;-><init>(Ljava/io/InputStream;)V

    .line 87
    invoke-virtual {p1}, Lcom/impalastudios/theflighttracker/util/migration/CrDecompressibleInputStream;->readObject()Ljava/lang/Object;

    move-result-object v1

    .line 88
    invoke-virtual {p1}, Lcom/impalastudios/theflighttracker/util/migration/CrDecompressibleInputStream;->close()V
    :try_end_0
