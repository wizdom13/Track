...
.method private final startCamera()V
    ...
    invoke-virtual {v1, v3}, Landroidx/camera/core/Preview$Builder;->setCameraSelector(Landroidx/camera/core/CameraSelector;)Landroidx/camera/core/Preview$Builder;
    ...
    iget-object v3, v3, Lcom/impalastudios/theflighttracker/databinding/CodescannerLayoutBinding;->viewFinder:Landroidx/camera/view/PreviewView;
    ...
    iget-object v2, p0, Lcom/impalastudios/theflighttracker/features/boardingpass/CameraFragment;->executor:Ljava/util/concurrent/Executor;
    ...
    invoke-virtual {v3, v2, v4}, Landroidx/camera/core/ImageAnalysis;->setAnalyzer(Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageAnalysis$Analyzer;)V

    new-instance v2, Lcom/impalastudios/theflighttracker/features/boardingpass/CameraFragment$$ExternalSyntheticLambda3;

    invoke-direct {v2, v0, p0, v1, v3}, Lcom/impalastudios/theflighttracker/features/boardingpass/CameraFragment$$ExternalSyntheticLambda3;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lcom/impalastudios/theflighttracker/features/boardingpass/CameraFragment;Landroidx/camera/core/Preview;Landroidx/camera/core/ImageAnalysis;)V
...
.method public codeCaptured(Lcom/impalastudios/theflighttracker/features/boardingpass/MapBoardingPassInfo;)V
    ...
    invoke-static {v2, v4}, Lj$/time/LocalDate;->ofYearDay(II)Lj$/time/LocalDate;
    ...
    invoke-static {v6, v4}, Lj$/time/LocalDate;->ofYearDay(II)Lj$/time/LocalDate;
    ...
    invoke-virtual {v2, v6}, Lj$/time/LocalDate;->isAfter(Lj$/time/chrono/ChronoLocalDate;)Z
...
.method public final verifyPassMatch(Lcom/impalastudios/theflighttracker/features/boardingpass/MapBoardingPassInfo;)Z
    ...
    invoke-static {v4, v5}, Lj$/time/LocalDate;->ofYearDay(II)Lj$/time/LocalDate;
    ...
    invoke-static {v6, v5}, Lj$/time/LocalDate;->ofYearDay(II)Lj$/time/LocalDate;
    ...
    invoke-static {v4}, Lj$/time/LocalDate;->from(Lj$/time/temporal/TemporalAccessor;)Lj$/time/LocalDate;
    ...
    invoke-virtual {p1, v0}, Lj$/time/LocalDate;->isEqual(Lj$/time/chrono/ChronoLocalDate;)Z
    ...
    invoke-static {v5}, Lj$/time/LocalDate;->from(Lj$/time/temporal/TemporalAccessor;)Lj$/time/LocalDate;
    ...
    invoke-static {v2}, Lj$/time/LocalDate;->from(Lj$/time/temporal/TemporalAccessor;)Lj$/time/LocalDate;
