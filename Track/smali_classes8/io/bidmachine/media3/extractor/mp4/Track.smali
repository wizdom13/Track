...
.method public copyWithoutEditLists()Lio/bidmachine/media3/extractor/mp4/Track;
    ...
    .line 145
    new-instance v0, Lio/bidmachine/media3/extractor/mp4/Track;

    iget v1, p0, Lio/bidmachine/media3/extractor/mp4/Track;->id:I

    iget v2, p0, Lio/bidmachine/media3/extractor/mp4/Track;->type:I

    iget-wide v3, p0, Lio/bidmachine/media3/extractor/mp4/Track;->timescale:J

    iget-wide v5, p0, Lio/bidmachine/media3/extractor/mp4/Track;->movieTimescale:J

    iget-wide v7, p0, Lio/bidmachine/media3/extractor/mp4/Track;->durationUs:J

    iget-object v9, p0, Lio/bidmachine/media3/extractor/mp4/Track;->format:Lio/bidmachine/media3/common/Format;

    iget v10, p0, Lio/bidmachine/media3/extractor/mp4/Track;->sampleTransformation:I

    iget-object v11, p0, Lio/bidmachine/media3/extractor/mp4/Track;->sampleDescriptionEncryptionBoxes:[Lio/bidmachine/media3/extractor/mp4/TrackEncryptionBox;

    iget v12, p0, Lio/bidmachine/media3/extractor/mp4/Track;->nalUnitLengthFieldLength:I

    const/4 v13, 0x0

    const/4 v14, 0x0

    invoke-direct/range {v0 .. v14}, Lio/bidmachine/media3/extractor/mp4/Track;-><init>(IIJJJLio/bidmachine/media3/common/Format;I[Lio/bidmachine/media3/extractor/mp4/TrackEncryptionBox;I[J[J)V
