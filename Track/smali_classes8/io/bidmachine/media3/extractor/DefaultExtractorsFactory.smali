...
.method public declared-synchronized createExtractors(Landroid/net/Uri;Ljava/util/Map;)[Lio/bidmachine/media3/extractor/Extractor;
    ...
    .line 430
    invoke-direct {p0, v5, v0}, Lio/bidmachine/media3/extractor/DefaultExtractorsFactory;->addExtractorsForFileType(ILjava/util/List;)V
    ...
    check-cast p2, Lio/bidmachine/media3/extractor/Extractor;

    .line 442
    iget-boolean v1, p0, Lio/bidmachine/media3/extractor/DefaultExtractorsFactory;->textTrackTranscodingEnabled:Z

    if-eqz v1, :cond_4

    .line 438
    invoke-interface {p2}, Lio/bidmachine/media3/extractor/Extractor;->getUnderlyingImplementation()Lio/bidmachine/media3/extractor/Extractor;

    move-result-object v1

    instance-of v1, v1, Lio/bidmachine/media3/extractor/mp4/FragmentedMp4Extractor;
    ...
    instance-of v1, v1, Lio/bidmachine/media3/extractor/mp4/Mp4Extractor;
    ...
    instance-of v1, v1, Lio/bidmachine/media3/extractor/ts/TsExtractor;
    ...
    instance-of v1, v1, Lio/bidmachine/media3/extractor/avi/AviExtractor;
    ...
    instance-of v1, v1, Lio/bidmachine/media3/extractor/mkv/MatroskaExtractor;

    if-nez v1, :cond_4

    .line 443
    new-instance v1, Lio/bidmachine/media3/extractor/text/SubtitleTranscodingExtractor;

    iget-object v2, p0, Lio/bidmachine/media3/extractor/DefaultExtractorsFactory;->subtitleParserFactory:Lio/bidmachine/media3/extractor/text/SubtitleParser$Factory;

    invoke-direct {v1, p2, v2}, Lio/bidmachine/media3/extractor/text/SubtitleTranscodingExtractor;-><init>(Lio/bidmachine/media3/extractor/Extractor;Lio/bidmachine/media3/extractor/text/SubtitleParser$Factory;)V
