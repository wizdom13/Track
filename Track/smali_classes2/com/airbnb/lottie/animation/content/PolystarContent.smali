...
.method private createPolygonPath()V
    ...
    sub-float v32, v10, v2

    sub-float v33, v11, v0

    add-float v34, v14, v1

    add-float v35, v26, v9
    ...
    iget-object v0, v8, Lcom/airbnb/lottie/animation/content/PolystarContent;->lastSegmentPathMeasure:Landroid/graphics/PathMeasure;

    iget-object v1, v8, Lcom/airbnb/lottie/animation/content/PolystarContent;->lastSegmentPath:Landroid/graphics/Path;

    const/4 v12, 0x0

    invoke-virtual {v0, v1, v12}, Landroid/graphics/PathMeasure;->setPath(Landroid/graphics/Path;Z)V
    ...
    iget-object v2, v8, Lcom/airbnb/lottie/animation/content/PolystarContent;->lastSegmentPosition:[F

    const/4 v9, 0x0

    invoke-virtual {v0, v1, v2, v9}, Landroid/graphics/PathMeasure;->getPosTan(F[F[F)Z

    iget-object v0, v8, Lcom/airbnb/lottie/animation/content/PolystarContent;->path:Landroid/graphics/Path;

    iget-object v1, v8, Lcom/airbnb/lottie/animation/content/PolystarContent;->lastSegmentPosition:[F
    ...
    iget-object v13, v8, Lcom/airbnb/lottie/animation/content/PolystarContent;->path:Landroid/graphics/Path;

    sub-float v21, v10, v2

    sub-float v22, v11, v0

    add-float v23, v25, v1

    add-float v24, v26, v9
    ...
    :cond_3
    iget-object v2, v8, Lcom/airbnb/lottie/animation/content/PolystarContent;->path:Landroid/graphics/Path;
