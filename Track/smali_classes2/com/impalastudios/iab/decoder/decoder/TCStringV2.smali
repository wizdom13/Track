...
.method private fillPublisherRestrictions(Ljava/util/List;ILcom/impalastudios/iab/decoder/utils/BitReader;)I
    ...
    invoke-static {v5, v4, p2, v6}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->vendorIdsFromRange(Lcom/impalastudios/iab/decoder/utils/BitReader;Ljava/util/BitSet;ILj$/util/Optional;)I
...
.method static fillVendors(Lcom/impalastudios/iab/decoder/utils/BitReader;Lcom/impalastudios/iab/decoder/utils/FieldDefs;Lcom/impalastudios/iab/decoder/utils/FieldDefs;)Lcom/impalastudios/iab/decoder/utils/BitSetIntIterable;
    ...
    invoke-static {p0, v0, p2, p1}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->vendorIdsFromRange(Lcom/impalastudios/iab/decoder/utils/BitReader;Ljava/util/BitSet;Lcom/impalastudios/iab/decoder/utils/FieldDefs;Lj$/util/Optional;)V
...
.method static vendorIdsFromRange(Lcom/impalastudios/iab/decoder/utils/BitReader;Ljava/util/BitSet;ILj$/util/Optional;)I
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v4}, Lcom/impalastudios/iab/decoder/utils/BitReader;->readBits16(I)I

    move-result v5

    sget-object v6, Lcom/impalastudios/iab/decoder/utils/FieldDefs;->START_OR_ONLY_VENDOR_ID:Lcom/impalastudios/iab/decoder/utils/FieldDefs;

    invoke-virtual {v6, p0}, Lcom/impalastudios/iab/decoder/utils/FieldDefs;->getLength(Lcom/impalastudios/iab/decoder/utils/BitReader;)I
...
.method static vendorIdsFromRange(Lcom/impalastudios/iab/decoder/utils/BitReader;Ljava/util/BitSet;Lcom/impalastudios/iab/decoder/utils/FieldDefs;Lj$/util/Optional;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->vendorIdsFromRange(Lcom/impalastudios/iab/decoder/utils/BitReader;Ljava/util/BitSet;ILj$/util/Optional;)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->getCreated()Lj$/time/Instant;

    move-result-object v2

    invoke-virtual {p1}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->getCreated()Lj$/time/Instant;
    ...
    invoke-virtual {p0}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->getLastUpdated()Lj$/time/Instant;

    move-result-object v2

    invoke-virtual {p1}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->getLastUpdated()Lj$/time/Instant;
...
.method public getCreated()Lj$/time/Instant;
    ...
    iput-object v0, p0, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->consentRecordCreated:Lj$/time/Instant;

    :cond_0
    iget-object v0, p0, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->consentRecordCreated:Lj$/time/Instant;
...
.method public getLastUpdated()Lj$/time/Instant;
    ...
    iput-object v0, p0, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->consentRecordLastUpdated:Lj$/time/Instant;

    :cond_0
    iget-object v0, p0, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->consentRecordLastUpdated:Lj$/time/Instant;
...
.method public hashCode()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->getCreated()Lj$/time/Instant;

    move-result-object v4

    invoke-virtual/range {p0 .. p0}, Lcom/impalastudios/iab/decoder/decoder/TCStringV2;->getLastUpdated()Lj$/time/Instant;
