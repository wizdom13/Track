...
.method private static final getStaticJsonValueGetter(Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    instance-of v8, v7, Lcom/fasterxml/jackson/annotation/JsonValue;

    if-eqz v8, :cond_0

    check-cast v7, Lcom/fasterxml/jackson/annotation/JsonValue;

    invoke-interface {v7}, Lcom/fasterxml/jackson/annotation/JsonValue;->value()Z
