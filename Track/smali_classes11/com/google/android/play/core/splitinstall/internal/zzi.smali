...
.method public static zza(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {v9, v5, v6, v12}, Ljava/io/RandomAccessFile;->readFully([BII)V

    const/4 v14, 0x0

    invoke-virtual {v4, v14}, Ljava/nio/ByteBuffer;->getLong(I)J
...
.method private static zzh(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
    ...
    const-string p1, "Failed to compute digest(s) of contents"
...
.method private static zzk([I[Lcom/google/android/play/core/splitinstall/internal/zzb;)[[B
    ...
    invoke-static {v3, v5, v2}, Lcom/google/android/play/core/splitinstall/internal/zzi;->zzg(I[BI)V
    ...
    :try_start_1
    invoke-interface {v9, v6, v7, v8, v3}, Lcom/google/android/play/core/splitinstall/internal/zzb;->zzb([Ljava/security/MessageDigest;JI)V
    :try_end_1
...
.method private static zzl(Ljava/nio/channels/FileChannel;Lcom/google/android/play/core/splitinstall/internal/zze;)[[Ljava/security/cert/X509Certificate;
    ...
    const-string p1, "Failed to read list of signers"
