...
.method private static load(Lio/bidmachine/media3/datasource/DataSource;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1
    ...
    invoke-static {p1, v0, p2}, Lio/bidmachine/media3/datasource/BitmapUtil;->decode([BILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method synthetic lambda$decodeBitmap$1$io-bidmachine-media3-datasource-DataSourceBitmapLoader([B)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v0, v1}, Lio/bidmachine/media3/datasource/BitmapUtil;->decode([BILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method synthetic lambda$loadBitmap$2$io-bidmachine-media3-datasource-DataSourceBitmapLoader(Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, p1, v1}, Lio/bidmachine/media3/datasource/DataSourceBitmapLoader;->load(Lio/bidmachine/media3/datasource/DataSource;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
