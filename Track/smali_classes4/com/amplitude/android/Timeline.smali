...
.method private final startNewSession(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget v3, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->label:I

    sub-int/2addr v3, v6

    iput v3, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->label:I
    ...
    invoke-direct {v4, v0, v3}, Lcom/amplitude/android/Timeline$startNewSession$1;-><init>(Lcom/amplitude/android/Timeline;Lkotlin/coroutines/Continuation;)V
    ...
    iget-boolean v1, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->Z$0:Z

    iget-wide v5, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->J$0:J

    iget-object v2, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->L$1:Ljava/lang/Object;

    check-cast v2, Ljava/util/List;

    iget-object v4, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->L$0:Ljava/lang/Object;

    check-cast v4, Lcom/amplitude/android/Timeline;
    ...
    iget-wide v8, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->J$0:J

    iget-object v2, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->L$1:Ljava/lang/Object;

    check-cast v2, Ljava/util/List;

    iget-object v6, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->L$0:Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lcom/amplitude/android/Timeline;->getAmplitude()Lcom/amplitude/core/Amplitude;

    move-result-object v6

    invoke-virtual {v6}, Lcom/amplitude/core/Amplitude;->getConfiguration()Lcom/amplitude/core/Configuration;

    move-result-object v6

    check-cast v6, Lcom/amplitude/android/Configuration;

    invoke-virtual {v6}, Lcom/amplitude/android/Configuration;->getTrackingSessionEvents()Z

    move-result v6

    if-eqz v6, :cond_5

    invoke-direct {v0}, Lcom/amplitude/android/Timeline;->inSession()Z

    move-result v9

    if-eqz v9, :cond_5

    new-instance v9, Lcom/amplitude/core/events/BaseEvent;

    invoke-direct {v9}, Lcom/amplitude/core/events/BaseEvent;-><init>()V

    const-string v10, "session_end"

    invoke-virtual {v9, v10}, Lcom/amplitude/core/events/BaseEvent;->setEventType(Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/amplitude/android/Timeline;->getLastEventTime()J
    ...
    :goto_1
    invoke-virtual {v9, v10}, Lcom/amplitude/core/events/BaseEvent;->setTimestamp(Ljava/lang/Long;)V
    ...
    invoke-virtual {v9, v10}, Lcom/amplitude/core/events/BaseEvent;->setSessionId(Ljava/lang/Long;)V
    ...
    iput-boolean v6, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->Z$0:Z

    iput v8, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->label:I

    invoke-direct {v0, v1, v2, v4}, Lcom/amplitude/android/Timeline;->setSessionId(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_2
    iput-object v8, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->L$0:Ljava/lang/Object;
    ...
    iput v7, v4, Lcom/amplitude/android/Timeline$startNewSession$1;->label:I

    invoke-direct {v8, v1, v2, v4}, Lcom/amplitude/android/Timeline;->refreshSessionTime(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    new-instance v1, Lcom/amplitude/core/events/BaseEvent;

    invoke-direct {v1}, Lcom/amplitude/core/events/BaseEvent;-><init>()V

    const-string v3, "session_start"

    invoke-virtual {v1, v3}, Lcom/amplitude/core/events/BaseEvent;->setEventType(Ljava/lang/String;)V

    invoke-static {v5, v6}, Lkotlin/coroutines/jvm/internal/Boxing;->boxLong(J)Ljava/lang/Long;

    move-result-object v3

    invoke-virtual {v1, v3}, Lcom/amplitude/core/events/BaseEvent;->setTimestamp(Ljava/lang/Long;)V

    invoke-virtual {v4}, Lcom/amplitude/android/Timeline;->getSessionId()J
    ...
    invoke-virtual {v1, v3}, Lcom/amplitude/core/events/BaseEvent;->setSessionId(Ljava/lang/Long;)V
