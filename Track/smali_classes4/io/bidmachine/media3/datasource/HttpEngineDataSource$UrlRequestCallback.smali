...
# direct methods
.method private constructor <init>(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)V
    .locals 0
...
.method synthetic constructor <init>(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Lio/bidmachine/media3/datasource/HttpEngineDataSource$1;)V
    .locals 0

    .line 1003
    invoke-direct {p0, p1}, Lio/bidmachine/media3/datasource/HttpEngineDataSource$UrlRequestCallback;-><init>(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)V
...
.method public declared-synchronized onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    :cond_0
    :try_start_1
    invoke-static {p3}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p3}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/net/http/NetworkException;

    move-result-object p1

    .line 1129
    invoke-static {p1}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/NetworkException;)I
    ...
    invoke-static {p1, p2}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$202(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-static {p1, p3}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$202(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Ljava/io/IOException;)Ljava/io/IOException;

    .line 1135
    :goto_0
    iget-object p1, p0, Lio/bidmachine/media3/datasource/HttpEngineDataSource$UrlRequestCallback;->this$0:Lio/bidmachine/media3/datasource/HttpEngineDataSource;

    invoke-static {p1}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$300(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Lio/bidmachine/media3/common/util/ConditionVariable;
...
.method public declared-synchronized onRedirectReceived(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$100(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Lio/bidmachine/media3/datasource/DataSpec;
    ...
    .line 1018
    invoke-static {p2}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlResponseInfo;)I
    ...
    .line 1026
    invoke-static {p2}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;

    move-result-object v3

    .line 1028
    invoke-static {p2}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p2

    invoke-static {p2}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 1023
    invoke-static {p1, v1}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$202(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-static {v0}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$400(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Z
    ...
    invoke-static {v0}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$500(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)V
    ...
    .line 1040
    invoke-static {v0}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$600(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Z
    ...
    invoke-static {v2}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$700(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Z
    ...
    .line 1047
    invoke-static {p1}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-static {p2}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$800(Ljava/util/List;)Ljava/lang/String;
    ...
    :cond_6
    :try_start_4
    invoke-static {p1}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/net/http/UrlRequest;)V
    ...
    invoke-static {p2, p1}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$202(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Ljava/io/IOException;)Ljava/io/IOException;
    :try_end_7
...
.method public declared-synchronized onResponseStarted(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;)V
    ...
    invoke-static {p1, p2}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$1102(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Landroid/net/http/UrlResponseInfo;)Landroid/net/http/UrlResponseInfo;
...
.method public declared-synchronized onSucceeded(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;)V
    ...
    invoke-static {p1, p2}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->access$1202(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Z)Z
