...
.method constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Lio/bidmachine/media3/datasource/HttpDataSource$RequestProperties;Lcom/google/common/base/Predicate;Z)V
    ...
    invoke-static {p1}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/net/http/HttpEngine;
...
.method static synthetic access$100(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Lio/bidmachine/media3/datasource/DataSpec;
    .locals 0
...
.method static synthetic access$1102(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Landroid/net/http/UrlResponseInfo;)Landroid/net/http/UrlResponseInfo;
    .locals 0
...
.method static synthetic access$1202(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Z)Z
    .locals 0
...
.method static synthetic access$202(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Ljava/io/IOException;)Ljava/io/IOException;
    .locals 0
...
.method static synthetic access$300(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Lio/bidmachine/media3/common/util/ConditionVariable;
    .locals 0
...
.method static synthetic access$400(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Z
    .locals 0
...
.method static synthetic access$500(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)V
    .locals 0
...
.method static synthetic access$600(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Z
    .locals 0
...
.method static synthetic access$700(Lio/bidmachine/media3/datasource/HttpEngineDataSource;)Z
    .locals 0
...
.method static synthetic access$800(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 70
    invoke-static {p0}, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->parseCookies(Ljava/util/List;)Ljava/lang/String;
...
.method private buildRequestBuilder(Lio/bidmachine/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {v0, v1, v2, p2}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/HttpEngine;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 724
    invoke-static {p2, v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 725
    invoke-static {p2, v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest$Builder;Z)Landroid/net/http/UrlRequest$Builder;
    ...
    .line 738
    invoke-static {p2, v3, v2}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v1, v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0, p1}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest$Builder;Landroid/net/http/UploadDataProvider;Ljava/util/concurrent/Executor;)Landroid/net/http/UrlRequest$Builder;
...
.method private buildRequestWrapper(Lio/bidmachine/media3/datasource/DataSpec;)Lio/bidmachine/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    invoke-direct {v0, p0, v1}, Lio/bidmachine/media3/datasource/HttpEngineDataSource$UrlRequestCallback;-><init>(Lio/bidmachine/media3/datasource/HttpEngineDataSource;Lio/bidmachine/media3/datasource/HttpEngineDataSource$1;)V
    ...
    invoke-static {p1}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    .line 923
    invoke-static {p0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object p0

    invoke-static {p0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/HeaderBlock;)Ljava/util/List;
...
.method public declared-synchronized close()V
    ...
    .line 698
    iget-boolean v0, p0, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->opened:Z

    if-eqz v0, :cond_2

    .line 699
    iput-boolean v2, p0, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->opened:Z
...
.method getCurrentUrlRequestCallback()Landroid/net/http/UrlRequest$Callback;
    ...
    .line 711
    :cond_0
    invoke-virtual {v0}, Lio/bidmachine/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;->getUrlRequestCallback()Landroid/net/http/UrlRequest$Callback;
...
.method public getResponseCode()I
    ...
    invoke-static {v0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlResponseInfo;)I
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    :cond_0
    invoke-static {v0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object v0

    invoke-static {v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public getUri()Landroid/net/Uri;
    ...
    :cond_0
    invoke-static {v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public open(Lio/bidmachine/media3/datasource/DataSpec;)J
    ...
    .line 439
    iget-boolean v0, v1, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->opened:Z
    ...
    invoke-static {v0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;
    ...
    invoke-static {v4}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    .line 560
    :goto_1
    iput-boolean v2, v1, Lio/bidmachine/media3/datasource/HttpEngineDataSource;->opened:Z
    ...
    .line 521
    invoke-static {v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
