...
.method static transformResult(Lcom/squareup/picasso/Request;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v9, v7}, Landroid/graphics/Matrix;->setRotate(F)V
    ...
    :goto_6
    invoke-static {v10, v2, v3, v4, v6}, Lcom/squareup/picasso/BitmapHunter;->shouldResize(ZIIII)Z

    move-result v2

    if-eqz v2, :cond_f

    invoke-virtual {v9, v1, v5}, Landroid/graphics/Matrix;->preScale(FF)Z
