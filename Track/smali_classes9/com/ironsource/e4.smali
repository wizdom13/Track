...
.method static synthetic a(Lcom/ironsource/e4;Ljava/util/List;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/ironsource/e4;->a(Ljava/util/List;Ljava/util/List;J)V
...
.method private a(Ljava/util/List;Ljava/util/List;J)V
    ...
    check-cast p3, Lcom/ironsource/f4;

    invoke-virtual {p3}, Lcom/ironsource/f4;->a()Ljava/util/Map;
    ...
    invoke-virtual {p3}, Lcom/ironsource/f4;->c()Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/ironsource/f4;->e()J
    ...
    invoke-virtual {p3}, Lcom/ironsource/f4;->b()Ljava/lang/String;
...
# virtual methods
.method public a(Ljava/util/List;Lcom/ironsource/e4$b;JLjava/util/concurrent/TimeUnit;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance p1, Lcom/ironsource/e4$a;

    invoke-direct {p1, p0, p2}, Lcom/ironsource/e4$a;-><init>(Lcom/ironsource/e4;Lcom/ironsource/e4$b;)V
    ...
    invoke-interface {p2, p1}, Lcom/ironsource/e4$b;->onFailure(Ljava/lang/String;)V
