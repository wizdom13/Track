...
# instance fields
.field public a:Lcom/inmobi/media/t3;

.field public final b:Lcom/inmobi/media/gd;
...
.method public constructor <init>(Landroid/content/Context;Lcom/inmobi/commons/core/configs/AdConfig$WebAssetCacheConfig;)V
    ...
    iput-object v0, p0, Lcom/inmobi/media/hd;->b:Lcom/inmobi/media/gd;

    .line 50
    new-instance v0, Lcom/inmobi/media/hd$$ExternalSyntheticLambda0;

    invoke-direct {v0, p2, p0, p1}, Lcom/inmobi/media/hd$$ExternalSyntheticLambda0;-><init>(Lcom/inmobi/commons/core/configs/AdConfig$WebAssetCacheConfig;Lcom/inmobi/media/hd;Landroid/content/Context;)V
...
.method public static a(Landroid/content/Context;J)V
    ...
    invoke-static {p0, p2}, Lcom/inmobi/media/J5;->a(Landroid/content/Context;Ljava/lang/String;)Lcom/inmobi/media/K5;
...
.method public static final a(Lcom/inmobi/commons/core/configs/AdConfig$WebAssetCacheConfig;Lcom/inmobi/media/hd;Landroid/content/Context;)V
    .locals 5
    ...
    invoke-virtual {v0}, Lcom/inmobi/media/m3;->e()J
    ...
    invoke-static {p2, v0, v1}, Lcom/inmobi/media/hd;->a(Landroid/content/Context;J)V
    ...
    .line 19
    :cond_0
    invoke-virtual {p1, p2, p0, v0, v1}, Lcom/inmobi/media/hd;->a(Landroid/content/Context;Lcom/inmobi/commons/core/configs/AdConfig$WebAssetCacheConfig;J)V
...
# virtual methods
.method public final a(Ljava/lang/String;Lcom/inmobi/media/N4;)Ljava/io/InputStream;
    .locals 7
    ...
    .line 4
    invoke-virtual {v1, v4}, Lcom/inmobi/media/t3;->b(Ljava/lang/String;)Lcom/inmobi/media/s3;
    ...
    .line 5
    iget-object v4, v1, Lcom/inmobi/media/s3;->a:[Ljava/io/InputStream;
    ...
    sget-object v6, Lcom/inmobi/media/Bc;->b:Ljava/nio/charset/Charset;

    invoke-direct {v5, v4, v6}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V

    invoke-static {v5}, Lcom/inmobi/media/Bc;->a(Ljava/io/InputStreamReader;)Ljava/lang/String;
    ...
    .line 8
    iget-object v0, v1, Lcom/inmobi/media/s3;->a:[Ljava/io/InputStream;
...
.method public final a(Landroid/content/Context;Lcom/inmobi/commons/core/configs/AdConfig$WebAssetCacheConfig;J)V
    ...
    .line 99
    iget-object p3, p0, Lcom/inmobi/media/hd;->b:Lcom/inmobi/media/gd;

    .line 100
    sget-object p4, Lcom/inmobi/media/t3;->p:Ljava/util/regex/Pattern;
    ...
    invoke-direct {p4, v0, p1, p2, p3}, Lcom/inmobi/media/t3;-><init>(Ljava/io/File;JLcom/inmobi/media/gd;)V

    .line 110
    iget-object v1, p4, Lcom/inmobi/media/t3;->b:Ljava/io/File;
    ...
    .line 112
    :try_start_0
    invoke-virtual {p4}, Lcom/inmobi/media/t3;->c()V

    .line 113
    invoke-virtual {p4}, Lcom/inmobi/media/t3;->b()V
    ...
    iget-object v4, p4, Lcom/inmobi/media/t3;->b:Ljava/io/File;
    ...
    iput-object v1, p4, Lcom/inmobi/media/t3;->j:Ljava/io/BufferedWriter;
    :try_end_0
    ...
    .line 124
    invoke-virtual {p4}, Lcom/inmobi/media/t3;->close()V

    .line 125
    iget-object p4, p4, Lcom/inmobi/media/t3;->a:Ljava/io/File;

    invoke-static {p4}, Lcom/inmobi/media/Bc;->a(Ljava/io/File;)V
    ...
    .line 128
    invoke-virtual {p4}, Lcom/inmobi/media/t3;->d()V
    ...
    iput-object p4, p0, Lcom/inmobi/media/hd;->a:Lcom/inmobi/media/t3;
