...
.method static constructor <clinit>()V
    ...
    .line 62
    new-instance v0, Lio/bidmachine/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticLambda7;

    invoke-direct {v0}, Lio/bidmachine/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticLambda7;-><init>()V
...
.method private static varargs createMediaParserInstance(Landroid/media/MediaParser$OutputConsumer;Lio/bidmachine/media3/common/Format;ZLcom/google/common/collect/ImmutableList;Lio/bidmachine/media3/exoplayer/analytics/PlayerId;[Ljava/lang/String;)Landroid/media/MediaParser;
    ...
    invoke-static {p5, p0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;Landroid/media/MediaParser$OutputConsumer;)Landroid/media/MediaParser;
    ...
    .line 252
    :cond_0
    invoke-static {p0, p5}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser$OutputConsumer;[Ljava/lang/String;)Landroid/media/MediaParser;
    ...
    invoke-static {p0, p5, p3}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
    ...
    .line 254
    invoke-static {p0, p3, p2}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;

    .line 256
    const-string p2, "android.media.mediaparser.inBandCryptoInfo"

    invoke-static {p0, p2, v2}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
    ...
    invoke-static {p0, p2, p3}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
    ...
    invoke-static {p0, p1, v2}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
...
.method static synthetic lambda$static$0(Landroid/net/Uri;Lio/bidmachine/media3/common/Format;Ljava/util/List;Lio/bidmachine/media3/common/util/TimestampAdjuster;Ljava/util/Map;Lio/bidmachine/media3/extractor/ExtractorInput;Lio/bidmachine/media3/exoplayer/analytics/PlayerId;)Lio/bidmachine/media3/exoplayer/hls/HlsMediaChunkExtractor;
    ...
    invoke-direct {p2, v0, p3, v2, v1}, Lio/bidmachine/media3/exoplayer/hls/WebvttExtractor;-><init>(Ljava/lang/String;Lio/bidmachine/media3/common/util/TimestampAdjuster;Lio/bidmachine/media3/extractor/text/SubtitleParser$Factory;Z)V
    ...
    .line 105
    new-instance v2, Lio/bidmachine/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;

    invoke-direct {v2}, Lio/bidmachine/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;-><init>()V
    ...
    .line 106
    :goto_2
    invoke-virtual {v2, p2}, Lio/bidmachine/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->setMuxedCaptionFormats(Ljava/util/List;)V

    .line 108
    invoke-virtual {v2, p3}, Lio/bidmachine/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->setTimestampAdjuster(Lio/bidmachine/media3/common/util/TimestampAdjuster;)V
    ...
    .line 126
    invoke-static {p0, p2}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z

    .line 127
    invoke-static {p0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {v2, p3}, Lio/bidmachine/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->setSelectedParserName(Ljava/lang/String;)V
...
.method public isPackedAudioExtractor()Z
    ...
    invoke-static {v0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;)Ljava/lang/String;
...
.method public onTruncatedSegmentParsed()V
    ...
    invoke-static {}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m()Landroid/media/MediaParser$SeekPoint;

    move-result-object v1

    invoke-static {v0, v1}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekPoint;)V
...
.method public read(Lio/bidmachine/media3/extractor/ExtractorInput;)Z
    ...
    invoke-static {p1, v0}, Lio/bidmachine/media3/ui/DefaultTimeBar$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z
