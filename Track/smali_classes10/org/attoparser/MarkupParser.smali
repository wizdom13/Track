...
.method private parseBuffer([CIILorg/attoparser/IMarkupHandler;Lorg/attoparser/ParseStatus;)V
    ...
    iget v1, v7, Lorg/attoparser/ParseStatus;->line:I
    ...
    iget-object v4, v7, Lorg/attoparser/ParseStatus;->parsingDisabledLimitSequence:[C
    ...
    invoke-static {v2, v3, v9, v8, v4}, Lorg/attoparser/ParsingMarkupUtil;->findCharacterSequence([CII[I[C)I

    move-result v4

    if-ne v4, v10, :cond_1

    iget-object v1, v0, Lorg/attoparser/MarkupParser;->configuration:Lorg/attoparser/config/ParseConfiguration;

    invoke-virtual {v1}, Lorg/attoparser/config/ParseConfiguration;->isTextSplittable()Z
    ...
    iput v5, v7, Lorg/attoparser/ParseStatus;->line:I

    iput v6, v7, Lorg/attoparser/ParseStatus;->col:I
    ...
    iput-object v1, v7, Lorg/attoparser/ParseStatus;->parsingDisabledLimitSequence:[C
    ...
    :cond_3
    invoke-static {v2, v3, v9, v8}, Lorg/attoparser/ParsingMarkupUtil;->findNextStructureStart([CII[I)I
    ...
    :cond_6
    invoke-static {v2, v1, v9}, Lorg/attoparser/ParsingElementMarkupUtil;->isOpenElementStart([CII)Z

    move-result v4

    if-nez v4, :cond_7

    invoke-static {v2, v1, v9}, Lorg/attoparser/ParsingElementMarkupUtil;->isCloseElementStart([CII)Z

    move-result v12

    if-nez v12, :cond_7

    invoke-static {v2, v1, v9}, Lorg/attoparser/ParsingCommentMarkupUtil;->isCommentStart([CII)Z

    move-result v13

    if-nez v13, :cond_7

    invoke-static {v2, v1, v9}, Lorg/attoparser/ParsingCDATASectionMarkupUtil;->isCDATASectionStart([CII)Z

    move-result v14

    if-nez v14, :cond_7

    invoke-static {v2, v1, v9}, Lorg/attoparser/ParsingDocTypeMarkupUtil;->isDocTypeStart([CII)Z

    move-result v15

    if-nez v15, :cond_7

    invoke-static {v2, v1, v9}, Lorg/attoparser/ParsingXmlDeclarationMarkupUtil;->isXmlDeclarationStart([CII)Z

    move-result v16

    if-nez v16, :cond_7

    invoke-static {v2, v1, v9}, Lorg/attoparser/ParsingProcessingInstructionUtil;->isProcessingInstructionStart([CII)Z
    ...
    invoke-static {v8, v1}, Lorg/attoparser/ParsingLocatorUtil;->countChar([IC)V

    add-int/lit8 v11, v11, 0x1

    invoke-static {v2, v11, v9, v8}, Lorg/attoparser/ParsingMarkupUtil;->findNextStructureStart([CII[I)I
    ...
    :cond_a
    invoke-static {v2, v11, v9}, Lorg/attoparser/ParsingElementMarkupUtil;->isOpenElementStart([CII)Z

    move-result v12

    if-nez v12, :cond_b

    invoke-static {v2, v11, v9}, Lorg/attoparser/ParsingElementMarkupUtil;->isCloseElementStart([CII)Z

    move-result v13

    if-nez v13, :cond_b

    invoke-static {v2, v11, v9}, Lorg/attoparser/ParsingCommentMarkupUtil;->isCommentStart([CII)Z

    move-result v14

    if-nez v14, :cond_b

    invoke-static {v2, v11, v9}, Lorg/attoparser/ParsingCDATASectionMarkupUtil;->isCDATASectionStart([CII)Z

    move-result v15

    if-nez v15, :cond_b

    invoke-static {v2, v11, v9}, Lorg/attoparser/ParsingDocTypeMarkupUtil;->isDocTypeStart([CII)Z

    move-result v16

    if-nez v16, :cond_b

    invoke-static {v2, v11, v9}, Lorg/attoparser/ParsingXmlDeclarationMarkupUtil;->isXmlDeclarationStart([CII)Z

    move-result v17

    if-nez v17, :cond_b

    invoke-static {v2, v11, v9}, Lorg/attoparser/ParsingProcessingInstructionUtil;->isProcessingInstructionStart([CII)Z
    ...
    invoke-static {v2, v3, v9, v8}, Lorg/attoparser/ParsingDocTypeMarkupUtil;->findNextDocTypeStructureEnd([CII[I)I
    ...
    invoke-static {v2, v3, v9, v8}, Lorg/attoparser/ParsingMarkupUtil;->findNextStructureEndAvoidQuotes([CII[I)I
    ...
    :cond_14
    invoke-static {v2, v3, v9, v8}, Lorg/attoparser/ParsingMarkupUtil;->findNextStructureEndDontAvoidQuotes([CII[I)I
    ...
    invoke-static {v2, v1, v9, v8}, Lorg/attoparser/ParsingMarkupUtil;->findNextStructureEndDontAvoidQuotes([CII[I)I
