...
.method public final timeTexts(Landroid/content/Context;Lcom/impalastudios/flightsframework/models/FlightTimes;Z)Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Ljava/time/ZonedDateTime;->isAfter(Ljava/time/chrono/ChronoZonedDateTime;)Z
    ...
    invoke-virtual {v2, v4}, Ljava/time/ZonedDateTime;->isBefore(Ljava/time/chrono/ChronoZonedDateTime;)Z
    ...
    .line 48
    invoke-static {}, Lcom/impalastudios/theflighttracker/util/frameworkextensions/FlightExtensionsKt;->access$getSimpleDateFormat$p()Ljava/time/format/DateTimeFormatter;
    ...
    :cond_2
    invoke-static {}, Lcom/impalastudios/theflighttracker/util/frameworkextensions/FlightExtensionsKt;->access$getDate12hformat$p()Ljava/time/format/DateTimeFormatter;
    ...
    invoke-static {}, Lcom/impalastudios/theflighttracker/util/frameworkextensions/FlightExtensionsKt;->access$getAmPmFormat$p()Ljava/time/format/DateTimeFormatter;
...
.method public final timeTextsAMPM(Landroid/content/Context;Lcom/impalastudios/flightsframework/models/FlightTimes;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v4}, Ljava/time/ZonedDateTime;->isBefore(Ljava/time/chrono/ChronoZonedDateTime;)Z
...
.method public final timeTextsAMPM(Landroid/content/Context;Lcom/impalastudios/theflighttracker/shared/models/FlightLocationInfo;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p2}, Lcom/impalastudios/theflighttracker/shared/models/FlightLocationInfo;->getActualDate()Ljava/time/ZonedDateTime;
    ...
    invoke-virtual {v1, v3}, Ljava/time/ZonedDateTime;->isBefore(Ljava/time/chrono/ChronoZonedDateTime;)Z
    ...
    invoke-virtual {v3, v4}, Ljava/time/ZonedDateTime;->format(Ljava/time/format/DateTimeFormatter;)Ljava/lang/String;
