...
.method private static intersects(DDDDDZ)Z
    ...
    cmpg-double v8, p0, v1

    if-gtz v8, :cond_7

    cmpg-double v8, p2, v1

    if-gtz v8, :cond_7

    cmpl-double v1, p6, v5
    ...
    invoke-static/range {v8 .. v15}, Lcom/google/maps/android/PolyUtil;->tanLatGC(DDDD)D
    ...
    invoke-static/range {v8 .. v15}, Lcom/google/maps/android/PolyUtil;->mercatorLatRhumb(DDDD)D
...
.method private static isOnSegmentGC(DDDDDDD)Z
    ...
    invoke-static {v4, v5, v1, v2}, Lcom/google/maps/android/MathUtil;->sinSumFromHav(DD)D
...
.method public static locationIndexOnEdgeOrPath(Lcom/google/android/gms/maps/model/LatLng;Ljava/util/List;ZZD)I
    ...
    aput-wide v8, v12, v24

    aput-wide v33, v12, v19

    const/4 v8, 0x2

    aput-wide v31, v12, v8
