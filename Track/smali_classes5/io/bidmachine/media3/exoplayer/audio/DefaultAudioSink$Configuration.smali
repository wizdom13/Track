...
.method private createAudioTrack(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    .locals 2
    ...
    .line 2255
    invoke-direct {p0, p1, p2}, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrackV29(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    ...
    .line 2257
    invoke-direct {p0, p1, p2}, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrackV21(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    ...
    .line 2259
    :cond_1
    invoke-direct {p0, p1, p2}, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrackV9(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
...
.method private createAudioTrackV21(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    .locals 6

    .line 2281
    new-instance v0, Landroid/media/AudioTrack;

    iget-boolean v1, p0, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->tunneling:Z

    .line 2282
    invoke-static {p1, v1}, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->getAudioTrackAttributesV21(Lio/bidmachine/media3/common/AudioAttributes;Z)Landroid/media/AudioAttributes;

    move-result-object v1

    iget p1, p0, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->outputSampleRate:I

    iget v2, p0, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->outputChannelConfig:I

    iget v3, p0, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->outputEncoding:I

    .line 2283
    invoke-static {p1, v2, v3}, Lio/bidmachine/media3/common/util/Util;->getAudioFormat(III)Landroid/media/AudioFormat;
...
.method private createAudioTrackV29(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    .locals 3
    ...
    iget v1, p0, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->bufferSize:I
    ...
    iget p2, p0, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->outputMode:I
    ...
    .line 2275
    :goto_0
    invoke-static {p1, v0}, Lcom/inmobi/media/J0$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioTrack$Builder;Z)Landroid/media/AudioTrack$Builder;
...
# virtual methods
.method public buildAudioTrack(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    .locals 8
    ...
    .line 2221
    :try_start_0
    invoke-direct {p0, p1, p2}, Lio/bidmachine/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrack(Lio/bidmachine/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
