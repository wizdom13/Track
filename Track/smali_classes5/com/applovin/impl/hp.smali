...
.method private a(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    :goto_0
    iget-object v1, p0, Lcom/applovin/impl/hp;->l:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/applovin/impl/hp;->k:Ljava/util/HashMap;
    ...
    check-cast v3, Lcom/applovin/impl/ip;
    ...
    iget v5, v3, Lcom/applovin/impl/ip;->j:I
...
.method private a(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    iget-boolean p4, p0, Lcom/applovin/impl/hp;->c:Z

    if-eqz p4, :cond_2

    if-eqz p3, :cond_2

    invoke-static {v4, p5}, Lcom/applovin/impl/hp;->a(Ljava/lang/String;Ljava/util/Map;)Landroid/text/SpannableStringBuilder;
    ...
    :cond_2
    iget-object p4, p0, Lcom/applovin/impl/hp;->a:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/applovin/impl/hp;->k:Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/z4$b;->e()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v7}, Lcom/applovin/impl/hp;->a(I)Lcom/applovin/impl/hp;
    ...
    invoke-static {v4, v5}, Lcom/applovin/impl/hp;->a(Ljava/lang/String;Ljava/util/Map;)Landroid/text/SpannableStringBuilder;
...
.method private a(Ljava/util/Map;Lcom/applovin/impl/z4$b;III)V
    ...
    invoke-virtual {p2, v0}, Lcom/applovin/impl/z4$b;->a(Ljava/lang/CharSequence;)Lcom/applovin/impl/z4$b;
    ...
    invoke-virtual {v5}, Lcom/applovin/impl/kp;->j()F
    ...
    :cond_1
    invoke-virtual {v5}, Lcom/applovin/impl/kp;->l()Landroid/text/Layout$Alignment;
    ...
    :cond_2
    invoke-virtual {v5}, Lcom/applovin/impl/kp;->g()Landroid/text/Layout$Alignment;
...
.method public a(JLjava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    iget-object v7, v2, Lcom/applovin/impl/hp;->h:Ljava/lang/String;
    ...
    invoke-virtual {v1, p4}, Lcom/applovin/impl/z4$b;->a(Landroid/graphics/Bitmap;)Lcom/applovin/impl/z4$b;

    move-result-object p4

    iget v1, p3, Lcom/applovin/impl/ip;->b:F

    invoke-virtual {p4, v1}, Lcom/applovin/impl/z4$b;->b(F)Lcom/applovin/impl/z4$b;

    move-result-object p4

    invoke-virtual {p4, v0}, Lcom/applovin/impl/z4$b;->b(I)Lcom/applovin/impl/z4$b;

    move-result-object p4

    iget v1, p3, Lcom/applovin/impl/ip;->c:F

    invoke-virtual {p4, v1, v0}, Lcom/applovin/impl/z4$b;->a(FI)Lcom/applovin/impl/z4$b;

    move-result-object p4

    iget v0, p3, Lcom/applovin/impl/ip;->e:I

    invoke-virtual {p4, v0}, Lcom/applovin/impl/z4$b;->a(I)Lcom/applovin/impl/z4$b;

    move-result-object p4

    iget v0, p3, Lcom/applovin/impl/ip;->f:F

    invoke-virtual {p4, v0}, Lcom/applovin/impl/z4$b;->d(F)Lcom/applovin/impl/z4$b;

    move-result-object p4

    iget v0, p3, Lcom/applovin/impl/ip;->g:F

    invoke-virtual {p4, v0}, Lcom/applovin/impl/z4$b;->a(F)Lcom/applovin/impl/z4$b;

    move-result-object p4

    iget p3, p3, Lcom/applovin/impl/ip;->j:I

    invoke-virtual {p4, p3}, Lcom/applovin/impl/z4$b;->c(I)Lcom/applovin/impl/z4$b;
    ...
    check-cast p4, Lcom/applovin/impl/ip;
    ...
    invoke-static {p5}, Lcom/applovin/impl/hp;->a(Landroid/text/SpannableStringBuilder;)V

    iget p5, p4, Lcom/applovin/impl/ip;->c:F

    iget v0, p4, Lcom/applovin/impl/ip;->d:I

    invoke-virtual {p3, p5, v0}, Lcom/applovin/impl/z4$b;->a(FI)Lcom/applovin/impl/z4$b;

    iget p5, p4, Lcom/applovin/impl/ip;->e:I

    invoke-virtual {p3, p5}, Lcom/applovin/impl/z4$b;->a(I)Lcom/applovin/impl/z4$b;

    iget p5, p4, Lcom/applovin/impl/ip;->b:F

    invoke-virtual {p3, p5}, Lcom/applovin/impl/z4$b;->b(F)Lcom/applovin/impl/z4$b;

    iget p5, p4, Lcom/applovin/impl/ip;->f:F

    invoke-virtual {p3, p5}, Lcom/applovin/impl/z4$b;->d(F)Lcom/applovin/impl/z4$b;

    iget p5, p4, Lcom/applovin/impl/ip;->i:F

    iget v0, p4, Lcom/applovin/impl/ip;->h:I

    invoke-virtual {p3, p5, v0}, Lcom/applovin/impl/z4$b;->b(FI)Lcom/applovin/impl/z4$b;

    iget p4, p4, Lcom/applovin/impl/ip;->j:I

    invoke-virtual {p3, p4}, Lcom/applovin/impl/z4$b;->c(I)Lcom/applovin/impl/z4$b;
