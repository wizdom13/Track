...
.method static constructor <clinit>()V
    ...
    const-string v3, "REQUIRE_BALANCED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/attoparser/config/ParseConfiguration$ElementBalancing;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "AUTO_OPEN_CLOSE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/attoparser/config/ParseConfiguration$ElementBalancing;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/attoparser/config/ParseConfiguration$ElementBalancing;->AUTO_OPEN_CLOSE:Lorg/attoparser/config/ParseConfiguration$ElementBalancing;

    new-instance v5, Lorg/attoparser/config/ParseConfiguration$ElementBalancing;

    const-string v7, "AUTO_CLOSE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lorg/attoparser/config/ParseConfiguration$ElementBalancing;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lorg/attoparser/config/ParseConfiguration$ElementBalancing;->AUTO_CLOSE:Lorg/attoparser/config/ParseConfiguration$ElementBalancing;

    const/4 v7, 0x4

    new-array v7, v7, [Lorg/attoparser/config/ParseConfiguration$ElementBalancing;
    ...
    sput-object v7, Lorg/attoparser/config/ParseConfiguration$ElementBalancing;->$VALUES:[Lorg/attoparser/config/ParseConfiguration$ElementBalancing;
